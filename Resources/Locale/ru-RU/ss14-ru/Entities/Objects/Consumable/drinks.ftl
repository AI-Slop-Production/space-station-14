ent-DrinkCartonBaseFull = { [DrinkBaseMaterialCardboard, DrinkBase, DrinkBaseOpenable, DrinkVisualsOpenable] }
    .desc = { [DrinkBaseMaterialCardboard.desc, DrinkBase.desc, DrinkBaseOpenable.desc, DrinkVisualsOpenable.desc] }
    .suffix = Full
...
ent-DrinkCreamCartonXL = milk cream XL
    .desc = It's cream. Made from milk. What else did you think you'd find in there?
ent-DrinkBaseEmptyTrash = { entity }
    .desc = { entity.desc }
    .suffix = Empty
ent-DrinkBottleGlassBaseFull = { [DrinkBaseMaterialGlass, DrinkBase, DrinkBaseOpenable] }
    .desc = { [DrinkBaseMaterialGlass.desc, DrinkBase.desc, DrinkBaseOpenable.desc] }
    .suffix = Full
...
ent-DrinkBottlePlasticBaseFull = { [DrinkBaseMaterialPlastic, DrinkBase, DrinkBaseOpenable] }
    .desc = { [DrinkBaseMaterialPlastic.desc, DrinkBase.desc, DrinkBaseOpenable.desc] }
    .suffix = Full
...
ent-DrinkCanBaseFull = { [DrinkBaseMaterialMetal, DrinkBase, DrinkBaseOpenable, DrinkVisualsOpenable] }
    .desc = { [DrinkBaseMaterialMetal.desc, DrinkBase.desc, DrinkBaseOpenable.desc, DrinkVisualsOpenable.desc] }
    .suffix = Full
ent-DrinkColaCan = Space Cola can
    .desc = A sweet, carbonated soft drink.
ent-DrinkColaCanEmpty = { [DrinkBaseOpenableOpen, DrinkColaCan] }
    .desc = { [DrinkBaseOpenableOpen.desc, DrinkColaCan.desc] }
    .suffix = Empty
...
ent-Pitcher = metal pitcher
    .desc = A stainless steel insulated pitcher. Everyone's best friend in the morning.
ent-DrinkShakeBase = { [DrinkBaseMaterialGlass, DrinkBase] }
    .desc = 
...
ent-DrinkBottleCoffeeLiqueur = coffee liqueur bottle
    .desc = { [DrinkBottleBaseEmpty.desc, DrinkCoffeeLiqueurBottleFull.desc] }
ent-DrinkBottleNTCahors = nt cahors bottle
    .desc = { [DrinkBottleBaseEmpty.desc, DrinkBottleGlassBaseFull.desc] }
