...
ent-HandheldHealthAnalyzer = { [HandheldHealthAnalyzerUnpowered, PowerCellSlotSmallItem] }
    .desc = { [HandheldHealthAnalyzerUnpowered.desc, PowerCellSlotSmallItem.desc] }
    .suffix = 
