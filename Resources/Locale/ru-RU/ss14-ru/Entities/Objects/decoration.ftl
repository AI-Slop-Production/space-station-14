...
ent-Present = { [PresentBase, BaseStorageItem] }
    .desc = { [PresentBase.desc, BaseStorageItem.desc] }
    .suffix = Empty
ent-PresentRandomUnsafe = { [PresentBase, BaseItem] }
    .desc = { [PresentBase.desc, BaseItem.desc] }
    .suffix = Filled, any item
ent-PresentRandomInsane = { PresentRandomUnsafe }
    .desc = { PresentRandomUnsafe.desc }
    .suffix = Filled, any entity
ent-PresentRandom = { [PresentBase, BaseItem] }
    .desc = { [PresentBase.desc, BaseItem.desc] }
    .suffix = Filled Safe
ent-PresentRandomCoal = { [PresentBase, BaseItem] }
    .desc = { [PresentBase.desc, BaseItem.desc] }
    .suffix = Filled Coal
ent-PresentRandomCash = { [PresentBase, BaseItem] }
    .desc = { [PresentBase.desc, BaseItem.desc] }
    .suffix = Filled Cash
