...
ent-AmeControllerUnanchored = { AmeController }
    .desc = { AmeController.desc }
    .suffix = Unanchored
...
ent-GeneratorBasic = { BaseGenerator }
    .desc = { BaseGenerator.desc }
    .suffix = Basic, 3kW
ent-GeneratorBasic15kW = { BaseGenerator }
    .desc = { BaseGenerator.desc }
    .suffix = Basic, 15kW
ent-GeneratorWallmountBasic = { BaseGeneratorWallmount }
    .desc = { BaseGeneratorWallmount.desc }
    .suffix = Basic, 3kW
