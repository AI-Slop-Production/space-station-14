...
ent-WeldingFuelTank = fuel tank
    ...
    .suffix = Empty
ent-WeldingFuelTankFull = { WeldingFuelTank }
    .desc = { WeldingFuelTank.desc }
    .suffix = Full
...
ent-WaterTankHighCapacity = high-capacity water tank
    ...
    .suffix = Full
ent-GenericTank = { [StorageTank, StructureWheeled] }
    .desc = { [StorageTank.desc, StructureWheeled.desc] }
    .suffix = Empty
