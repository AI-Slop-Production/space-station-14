...
ent-ClothingMaskNeckGaiterRed = red neck gaiter
    .desc = { ClothingMaskNeckGaiter.desc }
...
ent-ClothingMaskGasChameleon = gas mask
    .desc = A face-covering mask that can be connected to an air supply.
    .suffix = Chameleon
ent-ClothingMaskGasVoiceChameleon = { ClothingMaskGasChameleon }
    .desc = { ClothingMaskGasChameleon.desc }
