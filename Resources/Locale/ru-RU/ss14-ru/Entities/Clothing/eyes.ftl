...
ent-ClothingEyesGlassesHiddenSecurity = { [ClothingEyesGlassesSunglasses, ShowSecurityIcons] }
    .desc = { [ClothingEyesGlassesSunglasses.desc, ShowSecurityIcons.desc] }
    .suffix = Syndicate
...
ent-ClothingEyesEyepatchHudMedicalFlipped = medical hud eyepatch
    .desc = { [ClothingEyesEyepatchHudMedical.desc, ClothingHeadEyeBaseFlipped.desc] }
...
ent-ClothingEyesEyepatchHudSecurityFlipped = security hud eyepatch
    .desc = { [ClothingEyesEyepatchHudSecurity.desc, ClothingHeadEyeBaseFlipped.desc] }
...
ent-ClothingEyesEyepatchHudBeerFlipped = beer hud eyepatch
    .desc = { [ClothingEyesEyepatchHudBeer.desc, ClothingHeadEyeBaseFlipped.desc] }
ent-ClothingEyesEyepatchHudDiag = diagnostic hud eyepatch
    .desc = A heads-up display capable of analyzing the integrity and status of robotics and exosuits. Made out of see-borg-ium.
ent-ClothingEyesEyepatchHudDiagFlipped = diagnostic hud eyepatch
    .desc = { [ClothingEyesEyepatchHudDiag.desc, ClothingHeadEyeBaseFlipped.desc] }
ent-ClothingEyesBlindfold = blindfold
    .desc = The bind leading the blind.
ent-ClothingEyesEyepatch = eyepatch
    .desc = Yarr.
ent-ClothingEyesEyepatchFlipped = { [ClothingEyesEyepatch, ClothingHeadEyeBaseFlipped] }
    .desc = { [ClothingEyesEyepatch.desc, ClothingHeadEyeBaseFlipped.desc] }
    .suffix = flipped
