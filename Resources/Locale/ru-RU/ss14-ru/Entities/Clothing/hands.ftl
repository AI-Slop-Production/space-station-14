...
ent-ClothingHandsGlovesConducting = { ClothingHandsGlovesColorYellow }
    .desc = { ClothingHandsGlovesColorYellow.desc }
    .suffix = Conducting
...
ent-ClothingHandsGlovesBoxingRigged = { ClothingHandsGlovesBoxingBlue }
    .desc = { ClothingHandsGlovesBoxingBlue.desc }
    .suffix = Rigged
...
ent-ThievingGloves = { ClothingHandsGlovesColorBlack }
    .desc = { ClothingHandsGlovesColorBlack.desc }
    .suffix = Thieving
...
ent-ClothingHandsChameleon = black gloves
    .desc = Regular black gloves that do not keep you from frying.
    .suffix = Chameleon
ent-ClothingHandsChameleonThief = { ClothingHandsChameleon }
    .desc = { ClothingHandsChameleon.desc }
