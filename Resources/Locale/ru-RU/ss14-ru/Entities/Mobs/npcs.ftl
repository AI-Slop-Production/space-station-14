...
ent-BaseMobArgocyte = { [BaseSimpleMob, MobCombat] }
...
ent-MobOreCrab = ore crab
    .desc = { [MobElementalBase.desc, MobCombat.desc] }
...
ent-BaseSimpleMob = { [BaseMob, MobDamageable, MobPolymorphable] }
    .desc = { [BaseMob.desc, MobDamageable.desc, MobPolymorphable.desc] }
    .suffix = AI
ent-SimpleSpaceMobBase = { [BaseSimpleMob, MobAtmosExposed, MobCombat, MobBloodstream, MobFlammable] }
    .desc = { [BaseSimpleMob.desc, MobAtmosExposed.desc, MobCombat.desc, MobBloodstream.desc, MobFlammable.desc] }
    .suffix = AI
ent-SimpleMobBase = { [MobRespirator, MobAtmosStandard, SimpleSpaceMobBase] }
    .desc = { [MobRespirator.desc, MobAtmosStandard.desc, SimpleSpaceMobBase.desc] }
    .suffix = AI
